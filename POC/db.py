...
DATABASE_URL = "sqlite:///db/chatbot_test.db"
try:
...
class User(Base):
    ...
    session = relationship("ChatSession", back_populates="user", cascade="all, delete-orphan")
...
class ChatHistory(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    user_id = Column(Integer, ForeignKey("users_v3.id", ondelete="CASCADE"))
